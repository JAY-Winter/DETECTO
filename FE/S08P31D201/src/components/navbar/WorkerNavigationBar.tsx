...
function WorkerNavigationBar({ setMode, isModal = false }: NavigationBarProps) {
      ...
      <div css={bodyContainer}>
        ...
        <ul css={listContainer}>
          ...
          <ListItem
            ...
            onSetOffset={setSelectedItemOffsetTop}
          />
          <ListItem
            renderMode="desktop"
        ...
        <div css={footerContainer}>
          ...
          <div css={switchContainer}>
            <LightModeIcon
              color={theme.palette.mode === 'light' ? 'secondary' : 'disabled'}
            />
            <Switch
              color="default"
...
export default WorkerNavigationBar;
