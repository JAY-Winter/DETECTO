...
function WorkerNavigationBarTablet({ setMode }: NavigationBarTabletProps) {
      ...
      <StyledNav>
        ...
        <div css={bodyContainer}>
          ...
          <ul css={listContainer}>
            ...
            <ListItem
              renderMode="tablet"
              icon={<EngineeringOutlinedIcon fontSize="medium" />}
              pathName="/issue"
              currentPathName={currentPathName}
            />
          </ul>
...
export default WorkerNavigationBarTablet;
